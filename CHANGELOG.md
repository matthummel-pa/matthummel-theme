...
- Code page open-source section redesign: practice cards, richer activity feed, featured/live repo panels, skills mesh panel, documentation shelf (grouped tinted shelves, scroll jump chips, clearer card affordance), field-driven CTA; tighter title/meta
