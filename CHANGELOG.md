...
- Code page open-source section redesign: practice cards, richer activity feed, featured/live repo panels, skills mesh panel, grouped documentation shelf with host chips and jump links, field-driven CTA; tighter title/meta
