...
Custom WordPress theme for [matthummel.com](https://matthummel.com). Built on [Sage 11](https://roots.io/sage/) with Blade templates, Tailwind v4, Vite 8, and Acorn 6.
...
| [docs/INSTALL.md](docs/INSTALL.md) | WordPress install after deploy |
