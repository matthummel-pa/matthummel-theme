...
add_action('customize_register', function ($wp) {
    ...
    $wp->add_section('mh_extras_section', ['title' => __('Extras', 'matthummel'), 'panel' => 'mh_theme_options']);

    $select = function ($wp, $id, $label, $choices, $default, $section = 'mh_extras_section') {
    ...
    $bool = function ($wp, $id, $label, $default, $section = 'mh_extras_section') {
    ...
    $select($wp, 'mh_base_font', __('Base font size', 'matthummel'), ['15' => '15px', '16' => '16px', '17' => '17px (default)', '18' => '18px', '19' => '19px'], '17', 'mh_type');
    $select($wp, 'mh_body_lh', __('Body line height', 'matthummel'), ['1.5' => 'Tight (1.5)', '1.6' => '1.6', '1.7' => '1.7 (default)', '1.8' => 'Relaxed (1.8)', '2' => 'Loose (2.0)'], '1.7', 'mh_type');
    $select($wp, 'mh_head_lh', __('Heading line height', 'matthummel'), ['1' => '1.0', '1.1' => '1.1', '1.12' => '1.12 (default)', '1.2' => '1.2', '1.3' => '1.3'], '1.12', 'mh_type');
    $select($wp, 'mh_head_spacing', __('Heading letter spacing', 'matthummel'), ['-0.03em' => 'Tighter', '-0.02em' => 'Tight (default)', '0' => 'Normal', '0.02em' => 'Wide'], '-0.02em', 'mh_type');
