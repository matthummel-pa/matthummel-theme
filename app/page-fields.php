...
function mh_home_fields(): array
{
    return [
        ...
        __('Stack', 'sage') => [
            ['home_stack_kicker', __('Kicker', 'sage'), 'text', __('The stack', 'sage')],
            ['home_stack_h2', __('Heading', 'sage'), 'text', __('What I work with', 'sage')],
        ...
        __('Right now', 'sage') => [
            ...
            ['home_now_h2', __('Heading', 'sage'), 'text', __('WordPress, mostly.', 'sage')],
        ...
        __('Journal section', 'sage') => [
            ...
            ['home_write_h2', __('Heading', 'sage'), 'text', __('Recent posts', 'sage')],
            ['home_write_intro', __('Intro', 'sage'), 'textarea', __('Short posts on WordPress, plugins, and other web apps. Lots of snippets.', 'sage')],
        ...
        __('Code section', 'sage') => [
            ['home_code_kicker', __('Kicker', 'sage'), 'text', __('GitHub', 'sage')],
            ['home_code_h2', __('Heading', 'sage'), 'text', __('Code to copy', 'sage')],
            ['home_code_intro', __('Intro', 'sage'), 'textarea', __('Public repos and short snippets. Fork them or just read.', 'sage')],
            ['home_code_more', __('More link label', 'sage'), 'text', __('More repos and snippets', 'sage')],
        ],
        __('Example sites section', 'sage') => [
            ['home_work_kicker', __('Kicker', 'sage'), 'text', __('Example sites', 'sage')],
            ['home_work_h2', __('Heading', 'sage'), 'text', __('Work from the studio', 'sage')],
            ['home_work_intro', __('Intro (basic HTML ok)', 'sage'), 'html', __('Concept sites from <a href="https://ridgesandvalleys.com">Ridges &amp; Valleys</a> for Gettysburg shops, tours, and inns.', 'sage')],
        ...
        __('Help section', 'sage') => [
            ...
            ['home_help_h2', __('Heading', 'sage'), 'text', __('Let’s talk.', 'sage')],
            ...
            ['home_help_p2', __('Second paragraph (basic HTML ok)', 'sage'), 'html', __('Read <a href="/services/">how I can help</a>, or just send a note. A question about a post is just as welcome as a project inquiry.', 'sage')],
        ],
        __('Who it’s for', 'sage') => [
            ['home_who_kicker', __('Kicker', 'sage'), 'text', __('Who this is for', 'sage')],
            ['who_h2', __('Heading', 'sage'), 'text', __('Pick a starting point', 'sage')],
            ['who_intro', __('Intro', 'sage'), 'textarea', __('Same site. Useful from different angles.', 'sage')],
