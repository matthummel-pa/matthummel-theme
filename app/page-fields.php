...
function mh_home_fields(): array
{
    return [
        __('Hero', 'sage') => [
            ...
            ['home_cta_secondary_url', __('Secondary button path or URL', 'sage'), 'text', '/contact/'],
        ...
        __('What I do', 'sage') => [
            ...
            ['home_build_note', __('Side note', 'sage'), 'text', __('For shops and agencies. Stack notes are on About and Code.', 'sage')],
            ['home_build_1_title', __('Item 1 title', 'sage'), 'text', __('WordPress sites', 'sage')],
            ['home_build_1_text', __('Item 1 description', 'sage'), 'textarea', __('Custom themes shops can edit in wp-admin. You own the code.', 'sage')],
            ['home_build_2_title', __('Item 2 title', 'sage'), 'text', __('Plugins & tools', 'sage')],
            ['home_build_2_text', __('Item 2 description', 'sage'), 'textarea', __('Small PHP plugins when WordPress needs a new part.', 'sage')],
            ['home_build_3_title', __('Item 3 title', 'sage'), 'text', __('Full-stack web apps', 'sage')],
            ['home_build_3_text', __('Item 3 description', 'sage'), 'textarea', __('Interfaces, services, and APIs when a theme alone is not enough.', 'sage')],
        ],
        __('Services grid', 'sage') => [
            ['home_svc_h2', __('Section heading', 'sage'), 'text', __('How I can help.', 'sage')],
            ['home_svc_intro', __('Intro', 'sage'), 'textarea', __('Scoped WordPress and web work. Hire me for a build, overflow, or a full-time role.', 'sage')],
            ['home_svc_1_icon', __('Box 1 icon', 'sage'), 'text', 'wordpress'],
            ['home_svc_1_title', __('Box 1 title', 'sage'), 'text', __('Custom WordPress themes', 'sage')],
            ['home_svc_1_text', __('Box 1 text', 'sage'), 'textarea', __('Themes shops can edit in wp-admin. You own the repo.', 'sage')],
            ['home_svc_2_icon', __('Box 2 icon', 'sage'), 'text', 'plugins'],
            ['home_svc_2_title', __('Box 2 title', 'sage'), 'text', __('Plugins & tools', 'sage')],
            ['home_svc_2_text', __('Box 2 text', 'sage'), 'textarea', __('Small PHP plugins when WordPress needs a new part.', 'sage')],
            ['home_svc_3_icon', __('Box 3 icon', 'sage'), 'text', 'code'],
            ['home_svc_3_title', __('Box 3 title', 'sage'), 'text', __('Web applications', 'sage')],
            ['home_svc_3_text', __('Box 3 text', 'sage'), 'textarea', __('Interfaces, services, and APIs when a theme alone is not enough.', 'sage')],
            ['home_svc_4_icon', __('Box 4 icon', 'sage'), 'text', 'users'],
            ['home_svc_4_title', __('Box 4 title', 'sage'), 'text', __('Agency overflow', 'sage')],
            ['home_svc_4_text', __('Box 4 text', 'sage'), 'textarea', __('Scoped extra hands for a build or a handoff you can keep.', 'sage')],
            ['home_svc_5_icon', __('Box 5 icon', 'sage'), 'text', 'search'],
            ['home_svc_5_title', __('Box 5 title', 'sage'), 'text', __('Performance & SEO', 'sage')],
            ['home_svc_5_text', __('Box 5 text', 'sage'), 'textarea', __('Fast pages, clear titles, and markup search can read.', 'sage')],
            ['home_svc_6_icon', __('Box 6 icon', 'sage'), 'text', 'shield'],
            ['home_svc_6_title', __('Box 6 title', 'sage'), 'text', __('Accessibility', 'sage')],
            ['home_svc_6_text', __('Box 6 text', 'sage'), 'textarea', __('Keyboard paths, contrast, and labels that make sense.', 'sage')],
        ],
