...
function mh_home_fields(): array
{
    return [
        __('Hero', 'sage') => [
            ...
            ['home_lede', __('Intro', 'sage'), 'textarea', __('I build WordPress sites, plugins, and other web apps in Gettysburg. Shops get a site they can edit. Developers can copy the code.', 'sage')],
    ...
    $map = [
        ...
        'template-code.blade.php' => [
            ...
            __('Resume', 'sage') => [
                ...
                ['code_cv_intro', __('Intro', 'sage'), 'textarea', __('Based in Gettysburg, PA. I just started Ridges & Valleys and I work with shops and agencies in any location. Saliense was a government contract. Full-time web work at Germanna Community College ended in 2020.', 'sage')],
