    ...
    $map = [
        ...
        'template-code.blade.php' => [
            ...
            __('GitHub', 'sage') => [
                ...
                ['code_star_h3', __('Stargazers heading', 'sage'), 'text', __('Repo stargazers', 'sage')],
                ['code_star_thanks', __('Stargazers thank-you', 'sage'), 'textarea', __('Thank you to everyone who starred a public repo. Stars help other developers find the work.', 'sage')],
