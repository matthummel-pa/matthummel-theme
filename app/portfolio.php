...
function mh_code_resume_defaults(): array
{
    return [
        ...
        [
            ...
            'url' => '',
            'bullets' => "Government contract through Saliense: Power Apps, Power Automate, and Dataverse for government teams.\nConnected Microsoft 365 workloads to the data and approvals those teams already used.\nNo longer in that contract. WordPress and public web work stayed a parallel practice.",
        ],
        [
            'role' => 'Web Developer',
            ...
            'bullets' => "Full-time web developer at Germanna Community College through 2020.\nHTML, CSS, JavaScript, and WordPress for higher-ed sites and staff-facing tools.\nI left that role in 2020.",
        ],
    ];
}
