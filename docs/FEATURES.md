...
| About | Hero (rewritten blurb, fact chips, dual CTAs, jump chips, squared photo), stats, story + GitHub/studio cards, field-driven services & approach, open-for-work arrangements, journal preview, elsewhere, CTA | `template-about.blade.php` |
