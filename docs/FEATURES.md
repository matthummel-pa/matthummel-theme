...
| Code | Open-source GitHub showcase (profile panel, 60-day contribution circles newest-first with hover tips, typed activity feed, featured/recent repos), skill chips, docs | `template-code.blade.php`, `App\Github`, `partials/repo-card.blade.php` |
