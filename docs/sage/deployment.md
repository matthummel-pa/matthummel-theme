...
Production WordPress is **[matthummel.com](https://matthummel.com)** on Hostinger.
...
### Hostinger File Manager (also no FTP)
...
3. hPanel → File Manager → `wp-content/themes/`
