...
This theme is installed from the `theme-latest` GitHub Release (Appearance → Update Theme) or by cloning the repo, running `composer install` and `npm run build`, and activating the `matthummel` folder.
...
Acreline: https://github.com/matthummel-pa/wp-acreline
...
See CREDITS.md for fonts, Sage, highlight.js, and other licenses.
