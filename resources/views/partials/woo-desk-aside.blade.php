...
@php
  ...
  $sections = $sections ?? ['brief', 'steps', 'trust', 'faq', 'addons', 'help'];
  ...
  $show = static fn (string $key): bool => in_array($key, $sections, true);
@endphp

<div class="woo-desk-tools">

  @if ($show('brief') && $context === 'checkout')
    @php
