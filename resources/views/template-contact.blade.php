...
@section('content')
  ...
  @component('partials.page-hero', ['extra' => 'contact-hero'])
    ...
    <p class="lead">{{ \App\field('cnt_lede', __('Questions about a post, a snippet, or GitHub are welcome. So is a note about a WordPress site in Gettysburg. I usually reply in one or two business days.', 'sage')) }}</p>
  @endcomponent
