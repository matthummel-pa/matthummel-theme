  ...
  $sections = [
    ...
    [
      ...
      'items' => [
        ...
        ['Hostinger', 'Managed WordPress hosting for this site (`matthummel.com`). LiteSpeed cache, PHP 8.3+, hPanel. Theme installs from the GitHub `theme-latest` zip.', 'https://www.hostinger.com'],
